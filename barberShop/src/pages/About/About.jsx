...
import barber1 from '../../assets/Images/hero-bg.jpg'
...
const About = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        "Innovative stylist pushing the boundaries of modern barbering. Expert in avant-garde cuts and artistic hair designs.",
      specialties: ["Creative Cuts", "Hair Art", "Consultation"],
      imageUrl: barber1,
      avatarText: "SW",
    },
  ];
          ...
          <div className="about-section">
            <div className="section-card">
              ...
              <p className="section-text">
                ...
                where every client leaves feeling confident and refreshed.
              </p>
            </div>
          </div>
